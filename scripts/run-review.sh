...
{\"date\": \"${TODAY}\", \"targetSession\": \"<the next regular session these would execute in, YYYY-MM-DD>\", \"priceAsOf\": \"<the date of the closing prices you used, YYYY-MM-DD>\", \"decisions\": [{\"side\": \"buy|sell\", \"symbol\": \"SYM\", \"kind\": \"buy|trim|take-profit|stop-loss\", \"shares\": <number or null for notional buys>, \"notional\": <number>, \"priceUsed\": <number>, \"autoEligible\": <true|false>, \"reason\": \"<short>\"}], \"blocked\": [{\"symbol\": \"SYM\", \"rule\": \"<the rule that blocked it>\", \"value\": \"<the number behind it>\"}], \"decisionRequests\": [{\"key\": \"<SYMBOL>:buy-vs-exit\", \"symbol\": \"SYM\", \"question\": \"<the choice, in one line>\", \"readings\": [{\"side\": \"buy|exit\", \"detail\": \"<the rule and its number>\"}]}]}
